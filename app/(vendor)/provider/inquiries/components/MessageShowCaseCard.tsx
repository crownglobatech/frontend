...
export default function MessageShowcaseCard({ 
  ...
  return (
    <div className='flex items-center justify-between hover:bg-[var(--foundation-neutral-4)] w-full transition-all duration-300 cursor-pointer py-3 px-4'>
      <div className='flex items-center gap-4 flex-1 min-w-0'>
        ...
        <div className='flex-1 min-w-0'>
          <h2 className={`font-semibold text-[16px] truncate ${
            hasUnread ? 'text-black font-bold' : 'text-gray-900'
          }`}>
