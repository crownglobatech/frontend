  ...
  return (
    <div className="relative flex flex-col bg-white h-full">
      <div className="sticky top-0 z-10 bg-white shadow-md">
        <SearchMessages onSearchChange={setSearchQuery} searchQuery={searchQuery} />
      </div>
      <div className="flex-1 overflow-y-auto">
        <AllMessages conversations={filteredConversations} onSelectChat={onSelectChat} loading={loading} selectedChatId={selectedChatId} />
      </div>
    </div>
  );
}