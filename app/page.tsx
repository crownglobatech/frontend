  ...
  return (
    <main>
      ...
      <section className="relative flex flex-col bg-[url('/herobg.png')] bg-cover bg-no-repeat bg-top w-full h-[100vh]">
        ...
        <div className="z-10 relative flex justify-center px-4 pt-8 w-full">
          <motion.div
            ...
            className="flex justify-between items-center w-full md:max-w-[80%] max-w-[95%]"
          >
            <Header />
          </motion.div>
        </div>
        ...
        <div className="z-10 relative flex flex-col justify-center items-center px-8 md:px-20 h-full">
          ...
          <motion.div
            ...
            className="flex justify-center items-center gap-4 mt-6 md:mt-4"
          >
            <Button
              styles="text-white font-semibold border-none rounded-md text-[16px] md:text-[14px] px-4 py-2 bg-[var(--primary-color)]"
              title="View Property"
            />
            <Button
              styles="text-white font-semibold border-white border rounded-md text-[16px] md:text-[14px] px-4 py-2 bg-transparent"
              title="Contact Now"
            />
          </motion.div>
        </div>
      ...
      <section className="relative my-8">
        ...
        <div className="-top-24 left-1/2 absolute w-full max-w-[900px] -translate-x-1/2 hidden md:block">
          <motion.div
            viewport={{ once: true }}
            initial={{ y: 50, opacity: 0 }}
            whileInView={{ y: 0, opacity: 100 }}
        ...
        <div className="flex flex-col items-center md:py-[100px]">
          <motion.h2
            viewport={{ once: true }}
            initial={{ y: -50, opacity: 0 }}
            whileInView={{ y: 0, opacity: 100 }}
      ...
      <section className="md:flex flex-col items-center my-8 py-4 hidden">
        {/* reliable service */}
        <motion.h2
          viewport={{ once: true }}
          initial={{ y: -50, opacity: 0 }}
      ...
      <section className="flex flex-col justify-center items-center gap-4 bg-[var(--foundation-neutral-4)] mx-4 md:mx-20 my-8 py-4 rounded-md">
        {/* banner */}
        <motion.h2
          viewport={{ once: true }}
          initial={{ y: -50, opacity: 0 }}
        ...
        <motion.p
          ...
          className=" md:max-w-[60%] text-[var(--heading-color)] text-center"
        >
