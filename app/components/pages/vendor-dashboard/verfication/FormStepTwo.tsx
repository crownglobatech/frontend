...
export default function StepFormTwo ({ onValidityChange }: StepFormTwoProps) {
  ...
  return (
    <div className='bg-[var(--foundation-neutral-4)] shadow-md mx-auto p-6 rounded-md w-[70%]'>
      ...
      <div className='mt-4'>
        <label htmlFor='Id documents' className='font-semibold text-[var(--foundation-neutral)] text-sm'>
          {' '}
          Valid ID (NIN, Driver’s License, or Passport)  <span className='text-red-500'>*</span>
        </label>
        <label
          htmlFor='idFile'
          className='flex flex-col justify-center items-center bg-white mt-1 p-8 border-2 border-gray-300 hover:border-gray-400 border-dashed rounded-lg w-full text-center transition cursor-pointer'
        >
          {formData.idFile ? (
