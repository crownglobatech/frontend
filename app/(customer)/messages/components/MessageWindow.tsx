...
export default function MessageWindow() {
  return (
    <div className="flex-1 space-y-4 bg-gray-50 p-6 overflow-y-auto scrollbar-hide">
      {/* Received Message */}
      ...
      <div className="flex justify-end mr-8 text-[var(--muted-text)] text-xs">3:40PM</div>
